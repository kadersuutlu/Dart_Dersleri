...
void main(List<String> args) {
  ...
  SadeceOkuyabilenNormalUser userr = SadeceOkuyabilenNormalUser();
  userr.adiniSoyle();
  userr.girisYap();
  userr.girisYap();
  ...
  List<User> tumUserlar = []; //Bütün user türlerini tutabillir.
...
class AdminUser extends User {
  void toplamKullaniciSayisi() {
    print("Toplam kulanıcı sayısı 20");
  }
