...
artik nesne üretmeden bu değerlere erişebilir ve kullanabiliriz. Artık onlar nesnelerin değil sınıfın method ve değişkenleridir.
...
//class variable : sınıf değişkeni : erişmek için nesne üretmeye gerek yok.
  ...
  void cikar() {
    toplamIslemSayisi++;
    print("Çıkan ${birinciSayi - ikinciSayi}");
  }
}
